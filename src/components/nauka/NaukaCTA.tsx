...
export function NaukaCTA() {
  ...
  return (
    ...
    >
      ...
      >
        <h2
          className="mb-4 text-2xl tracking-[0.15em] text-[#f5f0e8] md:text-3xl lg:text-4xl"
        ...
        <a
          ...
          className="group inline-flex items-center gap-3 rounded-full border border-[#c9a96e]/25 bg-[#c9a96e]/5 px-8 py-4 transition-all duration-500 hover:border-[#c9a96e]/40 hover:bg-[#c9a96e]/10 hover:shadow-[0_0_40px_rgba(201,169,110,0.08)]"
        >
          {/* WhatsApp icon */}
      ...
      >
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-[10px] tracking-[0.2em] uppercase text-[#8a8578]/40">
            Undangan by Nauka
          </p>
        </div>
      </footer>
