...
// ── Helper: build WhatsApp URL untuk konfirmasi pesanan BERBAYAR ──
// (Untuk Luna free, pakai buildLunaFreeWaUrl — pesan berbeda)
function buildWaUrl(
  orderId: string,
  templateName: string,
...
export function NaukaCheckout({ templateName, templateId, basicPrice, premiumPrice, freeAvailable = false }: CheckoutProps) {
  ...
  // ── Step 3 → Step 4: FormDataUndangan / FreeForm submit ──
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[520px]">
        ...
        {/* ════════════════════════════════════════════════════════════ */}
        {/* STEP 3: UNDANGAN — conditional rendering                        */}
        {/*   - Luna free → NaukaFreeForm (simpel)                          */}
        {/*   - Sacred/Celestial → NaukaFormDataUndangan (lengkap)          */}
        {/* ════════════════════════════════════════════════════════════ */}
        {step === "undangan" && (
          <div>
                        <button
        ...
        {/* ════════════════════════════════════════════════════════════ */}
        {/* STEP 5: PEMBAYARAN — QRIS + tombol "saya sudah bayar"           */}
        {/* (HANYA untuk Basic/Premium — Luna free skip step ini)           */}
        {/* ════════════════════════════════════════════════════════════ */}
        ...
        {step === "done" && orderId && weddingData && (
          ...
          >
            ...
            {/* ── KHUSUS LUNA FREE: tampilkan link undangan prominently ── */}
            ...
            {/* ── KHUSUS LUNA FREE: tombol aksi untuk share undangan ── */}
            {isLunaFree && invitationUrl && (
              <div
                style={{
                  display: "flex",
            ...
            {/* ── UNTUK BERBAYAR: tombol WA konfirmasi ke admin ── */}
            {!isLunaFree && (
              <>
                <p
                  style={{
