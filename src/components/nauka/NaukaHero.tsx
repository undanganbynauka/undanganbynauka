  ...
  return (
    <section className="nauka-canvas relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6">
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        {/* Decorative line */}
        <div className="animate-nauka-fade-in-delay-2 flex items-center gap-3">
        ...
        {/* CTA Button */}
        <button
          className="animate-nauka-fade-in-delay-3 group relative mt-4 cursor-pointer overflow-hidden rounded-full border border-nauka-warm-400/40 bg-nauka-warm-50/60 px-10 py-3.5 font-serif text-base tracking-widest text-nauka-warm-700 backdrop-blur-sm transition-all duration-500 hover:border-nauka-gold/50 hover:bg-nauka-warm-100/60 hover:tracking-[0.25em] md:text-lg"
          style={{ fontFamily: "var(--font-cormorant)" }}
        >
